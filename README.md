...
[![GitHub Issues](https://img.shields.io/github/issues/glenluersman/git-it-done.svg)](https://github.com/glenluersman/git-it-done/issues)
[![GitHub Pull Requests](https://img.shields.io/github/issues-pr/glenluersman/git-it-done.svg)](https://github.com/glenluersman/git-it-done/pulls)
...
Git It Done is an application that allows the user to search for GitHub users with a list of their repositories and if there are any open issues.
...
Begin by typing a username into the form and click Get User. a list of repositories will be displayed on the right side. Results can be filtered by language by clicking one of the language buttons. Clicking on the repository will then display if the repository has any open issues.
...
<img style="margin: 0 0 15px 0" src="./assets/images/git-it-done.PNG" ></a>

<img style="margin: 0 0 15px 0" src="./assets/images/git-it-done2.PNG" ></a>

<img style="margin: 0 0 15px 0" src="./assets/images/git-it-done3.PNG" ></a>
